...
module.exports.DynamicValidated = nativeBinding.DynamicValidated
...
module.exports.acceptDeepValidatedObject = nativeBinding.acceptDeepValidatedObject
...
module.exports.acceptValidatedObject = nativeBinding.acceptValidatedObject
...
module.exports.createValidatedObject = nativeBinding.createValidatedObject
...
module.exports.DynamicSchemaType = nativeBinding.DynamicSchemaType
...
module.exports.processSerdeJson = nativeBinding.processSerdeJson
module.exports.processSmallUserValidated = nativeBinding.processSmallUserValidated
...
module.exports.saveToDynamicDb = nativeBinding.saveToDynamicDb
module.exports.saveToDynamicDbJs = nativeBinding.saveToDynamicDbJs
module.exports.saveUserToCustomDb = nativeBinding.saveUserToCustomDb
...
module.exports.validateAndProcessDynamic = nativeBinding.validateAndProcessDynamic
